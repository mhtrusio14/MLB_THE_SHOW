...
# use current year
pitcher_splits_url_suffix = f'/splits?region=us&lang=en&contentorigin=espn&season=2026&category=pitching'
hitter_splits_url_suffix = f'/splits?region=us&lang=en&contentorigin=espn&season=2026&category=batting'
...
# clear all values (not the headers) before updating
cell_range_clear = f'B2:{end_column}{players_sheet.row_count}'
players_sheet.batch_clear([cell_range_clear])
